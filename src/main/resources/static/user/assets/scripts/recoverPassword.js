    ...
    xhr.onreadystatechange = () => {
        ...
        const response = JSON.parse(xhr.responseText);
            const [title, content, onclick] = {
                failure: ['비밀번호 재설정', '비밀번호를 재설정할 수 없습니다. 링크가 올바르지 않거나 링크가 손상되었을 수 있습니다. <br><br> ㄷ오일한 문제가 반복된다면 비밀번호 재성정 링크를 다시 결성해 주세요.', ($dialog) => Dialog.hide($dialog)],
                failure_expired: ['비밀번호 재설정', '비밀번호를 재설정할 수 없습니다. 해당 링크는 더 이상 유효하지 않습니다. 애그튜브에서 인증 링크를 다시 받을 수 있습니다.'],
                success: ['비밀번호 재 설정', `비밀번호를 성공적으로 재설정하였습니다. 확인 버튼을 클릭하면 로그인 페이지로 이동합니다.`, () => location.href = '/'],
